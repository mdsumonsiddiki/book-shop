        ...
        <div className="container mx-auto pb-8 lg:pb-16 px-4 lg:px-0 py-6">
            ...
            <div className='mt-7 space-y-10'>
                ...
                <div className="relative w-full flex items-center justify-center">
                    <img className="w-full h-72 object-cover rounded-md" src={other} alt="" />
                    <div className='absolute text-center px-7 lg:px-0'>
                        <h2 className='text-white text-3xl lg:text-4xl font-bold'>Get <span className='text-[#FA7070]'>10%</span> Off Your Order!</h2>
