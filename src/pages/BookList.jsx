...
const BookList = () => {
    ...
    return (
        <div className="container mx-auto mt-7 px-4 lg:px-0 mb-10">
            ...
            <div className="mt-10 lg:mt-16 text-center flex items-center justify-between lg:px-7">
                <div className="flex items-center lg:w-4/12 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap ">
                    <Link to='' onClick={() => setTabIndex(0)} className={`px-3 lg:px-5 py-3 text-xl lg:text-2xl text-black font-bold ${tabIndex === 0 ? 'border-2 border-b-0 rounded-t-xl' : "border-b"}`}>
                        Read Books
                    </Link>
                    <Link to={'wishlist'} onClick={() => setTabIndex(1)} className={`px-3 lg:px-5 py-3 text-xl lg:text-2xl text-black font-bold ${tabIndex === 1 ? 'border-2 border-b-0 rounded-t-xl' : "border-b"}`}>
                        Wishlist Books
                    </Link>
                </div>
