...
const BooksDetails = () => {
    ...
    return (
        <div className='container mx-auto flex flex-col lg:flex-row gap-5 lg:gap-8 mt-4 md:mt-5 lg:mt-16 pb-16 px-3 lg:px-0'>
            <div className='lg:w-1/2 py-7 md:py-6 lg:py-0 bg-black bg-opacity-5 rounded-2xl flex items-center justify-center'>
            ...
            <div className='space-y-7 lg:w-1/2'>
                ...
                <ul className='flex flex-wrap lg:flex-nowrap items-center gap-4 border-b-2 pb-7 border-dashed border-black border-opacity-15'>
                ...
                <div className='lg:w-4/6 space-y-5 pb-7'>
