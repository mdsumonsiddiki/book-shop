...
const BooksCard = ({ book }) => {
    ...
    return (
        <Link to={`/books/${id}`} className='hover:shadow-2xl  border-2 border-[#13131326] p-6 rounded-xl'>
            ...
            <div className='space-y-5 mt-5'>
                ...
                <div className='flex items-center justify-between border-t-2 border-dashed border-black border-opacity-15 pt-5'>
                    ...
                    <p className='text-black font-medium text-lg flex items-center gap-2'><span>{rating}</span><FaRegStar /></p>
                </div>
            </div>
        </Link>
    );
